...
//
// Seven milestones, one due date each, listed in the order they fall due.
// Every task has an owner: estelle does the work (onsite 29 Sep – 19 Oct),
// dori decides and signs off, abiguelle has three fixed moments, andras
// guides remotely and carries no tasks. New tasks go at the end of a
// milestone's list: ids are positional and the live rows keep theirs.
...
export const planMilestones: SeedMilestone[] = [
  {
    id: "design", code: "01", title: "Design", dateLabel: "Thu 1 Oct", dueOn: "2026-10-01", owner: "dori",
    ...
    tasks: [
      t("Draft design: three directions for the name, the logo lockup and the colours on the bag.", "estelle", "2026-09-25"),
      t("Draft the label text with everything the law and the shops need: ingredients, allergens, net weight, dates, made in Tamarin. No health claim the recipe cannot back up.", "estelle", "2026-09-29"),
      t("Show the label to three people outside the club with the product clarity check. Fix the wording.", "estelle", "2026-10-01"),
      t("Send the print-ready label to the printer with the pouch order.", "estelle", "2026-10-02"),
      t("Final design: pick a direction from Estelle's drafts and finish the print-ready label.", "dori", "2026-10-01"),
    ],
  },
  {
    ...
    tasks: [
      t("Lock the ingredient list, bag weight and product name from the starter mix in the granola sheet. The list goes on the label and cannot change after this.", "estelle", "2026-09-28"),
  ...
  {
    id: "packaging", code: "03", title: "Packaging", dateLabel: "Fri 9 Oct", dueOn: "2026-10-09", owner: "estelle",
    deliverable: "Pouches and printed labels in hand, checked, one week before the bake.",
    tasks: [
      t("Reach out to two or three suppliers for quotes on stock stand-up pouches and printed labels: price, minimum order, lead time.", "estelle", "2026-09-23"),
      t("Choose the packaging provider from Estelle's quotes. Custom-printed pouches are out for this batch: four to eight weeks plus shipping.", "dori", "2026-09-25"),
      t("Place the pouch and label order.", "estelle", "2026-10-02"),
  ...
  },
  {
    ...
    tasks: [
      t("List six to eight shops in Tamarin, La Preneuse and Black River, and write a short intro message to send them.", "estelle", "2026-09-28"),
      ...
      t("Agree the trial terms and the first delivery date with each shop.", "dori", "2026-10-20"),
    ],
  },
  {
    id: "produce", code: "05", title: "Produce", dateLabel: "Thu 15 Oct", dueOn: "2026-10-15", owner: "estelle",
    deliverable: "The first batch baked, packed, numbered and counted, with the real cost per bag written down.",
    links: [{ label: "Granola sheet", file: "/branding-plan/business-case" }],
    tasks: [
      t("Confirm the kitchen for Wed 30 Sep, Wed 7 Oct and Wed 14 – Thu 15 Oct. Scales, trays and airtight containers are in it.", "estelle", "2026-09-28"),
      t("Check which food-handling or hygiene rule applies to selling a home-baked product at a club event.", "estelle", "2026-09-25"),
      t("Agree the price and the first-batch quantity from business case v1: how many bags to sell, how many to give away as tastings.", "dori", "2026-10-09"),
      t("Go / no-go: pouches, labels, ingredients, kitchen and helpers all confirmed.", "dori", "2026-10-12"),
      t("Buy all first-batch ingredients. Every receipt photographed into the sheet.", "estelle", "2026-10-12"),
      t("Bake and pack the first batch. Number the bags. Record ingredients, time and cost per bag.", "estelle", "2026-10-15"),
      t("Second pair of hands on the bake and the packing.", "abiguelle", "2026-10-15"),
    ],
  },
  {
    id: "buzz", code: "06", title: "Buzz", dateLabel: "Thu 15 Oct", dueOn: "2026-10-15", owner: "estelle",
    ...
    tasks: [
      t("Save-the-date to the parents WhatsApp group: Cup Vol. 02 on Friday 16 October, and “we are also cooking something for the day”.", "dori", "2026-09-18"),
      t("Instagram account live. Agree who posts.", "estelle", "2026-09-18"),
      t("Photo permission forms back from every family whose kid may appear on Instagram or the Cup pages.", "estelle", "2026-10-02"),
      ...
      t("Countdown week: schedule post, packaging sneak peek, “first batch reveal at the Cup”.", "estelle", "2026-10-15"),
    ],
  },
  {
    id: "event", code: "07", title: "Event", dateLabel: "Fri 16 Oct", dueOn: "2026-10-16", owner: "estelle",
    ...
    tasks: [
      t("Confirm Friday 16 October with the coach: the Cup replaces that day's training.", "dori", "2026-09-18"),
      t("Open registration. Confirm the coach for water marshals and the earlier start.", "dori", "2026-09-25"),
      ...
      t("Sign off the heat draw and the safety plan.", "dori", "2026-10-12"),
      ...
      t("Brief the judges and the setup crew at Monday training. Send the reminder on Thursday: time, what to bring, parents stay.", "estelle", "2026-10-15"),
      t("Run the desk and the run of show on the day.", "estelle", "2026-10-16"),
      t("Run the granola stall and the tally: bags sold, pre-orders, refusals and the reasons.", "abiguelle", "2026-10-16"),
      t("MC the day. Reveal the granola before the crowns.", "dori", "2026-10-16"),
      t("Results and thank-you on WhatsApp and Instagram, with the pre-order form for batch two.", "estelle", "2026-10-17"),
      t("The 48-hour report: bags sold, pre-orders, refusals, what people said.", "estelle", "2026-10-18"),
    ],
  },
];
