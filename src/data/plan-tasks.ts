...
export const planMilestones: SeedMilestone[] = [
  ...
  },
  {
    ...
    links: [{ label: "Granola sheet", file: "/branding-plan/business-case" }],
    tasks: [
      t("Confirm the kitchen for Wed 30 Sep, Wed 7 Oct and Thu 15 – Fri 16 Oct. Scales, trays and airtight containers are in it.", "estelle", "2026-09-28"),
  ...
  },
  {
    ...
    tasks: [
      t("Save-the-date to the parents WhatsApp group: Cup Vol. 02 on 17/18 October, and “we are also cooking something for the day”.", "dori", "2026-09-18"),
  ...
  },
  {
    ...
    tasks: [
      t("Pick the Cup day: Saturday 17 or Sunday 18 October.", "dori", "2026-09-18"),
      ...
      t("MC the day. Reveal the granola before the crowns.", "dori", "2026-10-17"),
      t("Results and thank-you on WhatsApp and Instagram, with the pre-order form for batch two.", "estelle", "2026-10-18"),
      t("The 48-hour report: bags sold, pre-orders, refusals, what people said.", "estelle", "2026-10-20"),
    ],
  },
];
