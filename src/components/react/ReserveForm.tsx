  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      {familyKids.length > 0 && <fieldset className="rounded-xl border border-line p-4">
        ...
        <p className="mb-3 text-sm text-fg-muted">The legal guardians of these duckies can see this reservation in their family order history. Granola orders also earn club points for each selected duckie.</p>
