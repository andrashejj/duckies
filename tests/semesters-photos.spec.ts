...
test.beforeEach(async ({ request }) => {
  await db.query(
    'TRUNCATE club_member_archive,club_parent_profile,club_kid,club_member,"user","session",account,verification,"rateLimit",shop_request_limit,club_semester CASCADE',
  );
  await db.query(
