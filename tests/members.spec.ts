...
async function sendCode(request: APIRequestContext, email: string) {
...
test.beforeEach(async () => {
  await db.query('TRUNCATE club_kid, club_member, "user", "session", account, verification, "rateLimit" CASCADE');
